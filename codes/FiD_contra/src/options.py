...
class Options():
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--perturb', type=float, default=0.0)
        self.parser.add_argument('--model_setting', type=str, default='parametric', help='parametric, semi_parametric, semi_parametric_pert')
        #self.parser.add_argument('--no_title', action='store_true')
    ...
    def initialize_parser(self):
        ...
        # training parameters
        self.parser.add_argument('--eval_freq', type=int, default=5000,
